...
def get_url():
    ...
    file = open("ayodhyakanda_english_intro.txt","w",encoding="utf-8")

    while number_of_chapters >= sarga_number:
        ls = []
        url = requests.get(f"http://www.valmikiramayan.net/utf8/ayodhya/sarga{sarga_number}/ayodhyasans{sarga_number}.htm")
