...
def get_url():
    ...
    excel_file = 'KishkindhaKanda.xlsx'
    ...
    file = open("kishkindha.txt","w",encoding="utf-8")

    while number_of_chapters >= sarga_number:
        url = requests.get(f"http://www.valmikiramayan.net/utf8/kish/sarga{sarga_number}/kishkindhasans{sarga_number}.htm")
    ...
    wc.to_file('wordcloud_kishkindha.png')
