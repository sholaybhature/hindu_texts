...
def get_url():
    ...
    file = open("balakanda.txt","w",encoding="utf-8")

    while number_of_chapters >= sarga_number:
        url = requests.get(f"http://www.valmikiramayan.net/utf8/baala/sarga{sarga_number}/balasans{sarga_number}.htm")
    ...
    wc.to_file('wordcloud_balakanda.png')
